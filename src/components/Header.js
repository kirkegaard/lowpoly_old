  ...
  return (
    <header>
      <div className="container">
        ...
        <p>
          I'm obsessed with music and currently I'm listening to:<br />
          <LastFM username={'ranza'} limit={3} apikey={'d58933bda5ed830aee4ef6e8abbad0a9'} />
        </p>
        <p>Oh and I'm also a motion designer, compositor and developer at <a href="https://m2film.dk">M2Film</a>.</p>
        <hr />
        <ul>
